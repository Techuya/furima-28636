...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録がうまくいかない時' do
      ...
      it "emailに@が含まれていない場合、登録ができない" do
      ...
      it "パスワードは６文字以上あっても半角数字のみでは登録できない" do
      ...
      it "パスワードは６文字以上あっても半角英字のみでは登録できない" do
      ...
      it "last nameは全角文字でないと登録ができない" do
      ...
      it "first nameは全角文字でないと登録ができない" do
      ...
      it "last name kanaは全角カタカナでないと登録ができない" do
      ...
      it "first name kanaは全角カタカナでないと登録ができない" do
